...
def setup_tools(mcp):
    ...
    async def get_all_products() -> Any:
        ...
        return await products_api.get_all_products()
    ...
    async def search_product_by_sku(sku: str) -> Any:
        ...
        # Asumiendo que get_all_products devuelve una lista de diccionarios
        if isinstance(products, list):
            for p in products:
                # Comparamos el SKU ignorando mayúsculas/minúsculas por seguridad
